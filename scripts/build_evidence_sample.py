#!/usr/bin/env python3
"""Create one OS-random evidence sample under tmp/evidence-check/<run-id>."""
...
from wiki_evidence import EvidenceRunError, create_evidence_sample
...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--count", type=int, default=25)
...
def main() -> int:
    ...
    try:
        manifest = create_evidence_sample(
            args.repo_root, args.run_id, args.count
        )
